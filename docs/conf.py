...
html_favicon = "assets/logo/N-Queens_problem_Python.ico"
html_theme_options = {
    "logo_only": False,
...
latex_documents = [
    ("index", "python-constraint.tex", "python-constraint Documentation", "Gustavo Niemeyer", "manual"),
]
...
man_pages = [("index", "python-constraint", "python-constraint Documentation", ["Gustavo Niemeyer"], 1)]
