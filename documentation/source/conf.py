...
htmlhelp_basename = 'python-constraintdoc'
...
latex_documents = [
  ('index', 'python-constraint.tex', u'python-constraint Documentation',
   u'Gustavo Niemeyer', 'manual'),
]
...
man_pages = [
    ('index', 'python-constraint', u'python-constraint Documentation',
     [u'Gustavo Niemeyer'], 1)
]
...
texinfo_documents = [
  ('index', 'python-constraint', u'python-constraint Documentation',
   u'Gustavo Niemeyer', 'python-constraint', 'Python Constraint Package.',
   'Miscellaneous'),
]
